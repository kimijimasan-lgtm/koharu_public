const DESTINATIONS = {
  kanazawa: {
    ...
    hotels: [
      ...
      },
      {
        ...
        name: '雨庵 金沢',
        type: 'デザイナーズホテル',
        image: 'images/hotel_designer.jpg',
  ...
  sapporo: {
    ...
    hotels: [
      { id: 'sp1', name: 'JRタワーホテル日航札幌', type: 'ラグジュアリーホテル', image: 'images/hotel_resort.jpg',
      ...
      { id: 'sp2', name: '定山渓温泉 章月グランドホテル', type: '温泉旅館', image: 'images/hotel_ryokan.jpg',
  ...
  asahikawa: {
    ...
    hotels: [
      { id: 'ak1', name: 'OMO7旭川 by 星野リゾート', type: 'デザイナーズホテル', image: 'images/hotel_designer.jpg',
      ...
      { id: 'ak2', name: 'ラビスタ層雲峡', type: 'リゾートホテル', image: 'images/hotel_resort.jpg',
  ...
  obihiro: {
    ...
    hotels: [
      { id: 'ob1', name: 'ふく井ホテル', type: 'シティホテル', image: 'images/hotel_city.jpg',
  ...
  kushiro: {
    ...
    hotels: [
      { id: 'ku1', name: 'ANA クラウンプラザホテル釧路', type: 'シティホテル', image: 'images/hotel_city.jpg',
  ...
  abashiri: {
    ...
    hotels: [
      { id: 'ab1', name: '天都の丘 網走観光ホテル', type: 'リゾートホテル', image: 'images/hotel_resort.jpg',
  ...
  wakkanai: {
    ...
    hotels: [
      { id: 'wk1', name: 'ドーミーイン稚内', type: 'ビジネスホテル', image: 'images/hotel_city.jpg',
