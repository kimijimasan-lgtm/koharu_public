const DESTINATIONS = {
  kanazawa: {
    ...
    hotels: [
      ...
      },
      {
        ...
        type: 'シティホテル',
        image: null,
        features: ['駅直結', '高層階パノラマビュー', 'スパ完備'],
        taxiFromCityStation: 1,
        area: '金沢駅前',
        pricePerNight: 28000,
      ...
      },
      {
        ...
        type: 'デザイナーズホテル',
        image: null,
        features: ['町家風デザイン', 'ライブラリーラウンジ', '大浴場あり'],
      ...
      },
      {
        ...
        type: '温泉旅館',
        image: null,
        features: ['柴山潟の絶景', '源泉かけ流し', '個室ダイニング'],
        taxiFromCityStation: 50,
        area: '片山津温泉',
        pricePerNight: 38000,
        dinnerIncluded: true,
        breakfastIncluded: true,
    ...
    restaurants: {
      lunch: [
        { name: '近江町市場 いきいき亭', genre: '海鮮丼', area: '近江町市場', reservationNeeded: false, budget: 3000 },
        { name: '金沢まいもん寿司 本店', genre: '回転寿司', area: '近江町市場周辺', reservationNeeded: true, budget: 4000 },
        { name: '加賀料理 まほろば', genre: '加賀料理', area: 'ひがし茶屋街', reservationNeeded: true, budget: 5000 },
      ],
      dinner: [
        { name: '割烹 みつ川', genre: '割烹', area: '片町', reservationNeeded: true, budget: 15000 },
        { name: '鮨 みつ叶', genre: '鮨', area: '片町', reservationNeeded: true, budget: 20000 },
        { name: 'ビストロ ユイガ', genre: 'フレンチ', area: '広坂', reservationNeeded: true, budget: 12000 },
      ],
      snack: [
        { name: '箔一 兼六園店', genre: '金箔ソフトクリーム', area: '兼六園', budget: 900 },
        { name: '森八 本店', genre: '和菓子・抹茶', area: '大手町', budget: 1200 },
        { name: 'ひがし茶屋街 茶房一笑', genre: '加賀棒茶・和菓子', area: 'ひがし茶屋街', budget: 1000 },
      ],
    },
    spots: [
      { name: '兼六園', area: '兼六園', duration: 90, indoor: false, taxiFromCityStation: 10 },
      { name: '21世紀美術館', area: '広坂', duration: 75, indoor: true, taxiFromCityStation: 10 },
      { name: 'ひがし茶屋街', area: 'ひがし茶屋街', duration: 60, indoor: false, taxiFromCityStation: 7 },
      { name: '近江町市場', area: '近江町市場', duration: 45, indoor: true, taxiFromCityStation: 5 },
      { name: '長町武家屋敷跡', area: '長町', duration: 45, indoor: false, taxiFromCityStation: 8 },
      { name: '鈴木大拙館', area: '本多町', duration: 40, indoor: true, taxiFromCityStation: 10 },
  ...
  kyoto: {
    ...
    hotels: [
      ...
      },
      {
        ...
        type: 'シティホテル',
        image: null,
        features: ['寺院一体型', '河原町アクセス抜群', '大浴場あり'],
        taxiFromCityStation: 8,
        area: '河原町',
        pricePerNight: 20000,
        dinnerIncluded: false,
        breakfastIncluded: true,
      },
      {
        ...
        type: 'シティホテル',
        image: null,
        features: ['祇園八坂の景観', '和モダンデザイン', '静かな立地'],
    ...
    restaurants: {
      lunch: [
        { name: '京都つゆしゃぶ CHIRIRI 祇園', genre: 'つゆしゃぶ', area: '祇園', reservationNeeded: true, budget: 5000 },
        { name: '天ぷら 圓堂 岡崎邸', genre: '天ぷら', area: '岡崎', reservationNeeded: true, budget: 8000 },
        { name: '嵐山よしむら', genre: '手打ち蕎麦', area: '嵐山', reservationNeeded: false, budget: 2500 },
      ],
      dinner: [
        { name: '祇園 にしかわ', genre: '京料理', area: '祇園', reservationNeeded: true, budget: 18000 },
        { name: '先斗町 ますだ', genre: '割烹', area: '先斗町', reservationNeeded: true, budget: 15000 },
        { name: 'リストランテ キメラ', genre: 'イタリアン', area: '東山', reservationNeeded: true, budget: 12000 },
      ],
      snack: [
        { name: '中村藤吉 京都駅店', genre: '抹茶パフェ', area: '京都駅', budget: 1500 },
        { name: '鍵善良房', genre: 'くずきり', area: '祇園', budget: 1200 },
        { name: '%ARABICA 京都 東山', genre: 'コーヒー', area: '東山', budget: 800 },
      ],
    },
    spots: [
      { name: '清水寺', area: '東山', duration: 75, indoor: false, taxiFromCityStation: 15 },
      { name: '伏見稲荷大社', area: '伏見', duration: 90, indoor: false, taxiFromCityStation: 10 },
      { name: '嵐山竹林の小径', area: '嵐山', duration: 45, indoor: false, taxiFromCityStation: 30 },
      { name: '金閣寺', area: '北山', duration: 50, indoor: false, taxiFromCityStation: 25 },
      { name: '南禅寺', area: '岡崎', duration: 50, indoor: false, taxiFromCityStation: 12 },
      { name: '錦市場', area: '河原町', duration: 45, indoor: true, taxiFromCityStation: 8 },
  ...
  hakone: {
    ...
    hotels: [
      ...
      },
      {
        ...
        type: 'リゾートホテル',
        image: null,
        features: ['全室露天風呂付', '森林ビュー', 'ラウンジ充実'],
        taxiFromCityStation: 28,
        area: '強羅',
        pricePerNight: 35000,
        dinnerIncluded: true,
        breakfastIncluded: true,
      },
      {
        ...
        type: 'リゾートホテル',
        image: null,
        features: ['芦ノ湖ビュー', 'インフィニティ足湯', 'ブッフェダイニング'],
        taxiFromCityStation: 35,
        area: '芦ノ湖',
        pricePerNight: 30000,
        dinnerIncluded: true,
        breakfastIncluded: true,
      },
      {
        ...
        type: 'デザイナーズホテル',
        image: null,
        features: ['モダンデザイン', '源泉かけ流し', 'クラフトカクテルバー'],
        taxiFromCityStation: 28,
        area: '強羅',
        pricePerNight: 32000,
        dinnerIncluded: false,
    ...
    restaurants: {
      lunch: [
        { name: '田むら銀かつ亭', genre: '豆腐かつ煮', area: '強羅', reservationNeeded: false, budget: 2000 },
        { name: 'ベーカリー&テーブル 箱根', genre: 'パン・カフェ', area: '芦ノ湖', reservationNeeded: false, budget: 2500 },
        { name: '甘酒茶屋', genre: '甘酒・力餅', area: '旧街道', reservationNeeded: false, budget: 1000 },
      ],
      dinner: [
        { name: '季節料理 はつ花 本店', genre: '蕎麦・和食', area: '湯本', reservationNeeded: false, budget: 4000 },
        { name: 'オー・ミラドー', genre: 'フレンチ', area: '強羅', reservationNeeded: true, budget: 15000 },
        { name: 'レストラン ロア', genre: '欧風料理', area: '仙石原', reservationNeeded: true, budget: 8000 },
      ],
      snack: [
        { name: '大涌谷 黒たまご', genre: '名物黒たまご', area: '大涌谷', budget: 500 },
        { name: '茶屋本陣 畔屋', genre: '甘味・抹茶', area: '芦ノ湖', budget: 1000 },
        { name: 'Cafe de motonami', genre: 'カフェ', area: '宮ノ下', budget: 1200 },
      ],
    },
    spots: [
      { name: '彫刻の森美術館', area: '強羅', duration: 90, indoor: false, taxiFromCityStation: 28 },
      { name: '大涌谷', area: '大涌谷', duration: 60, indoor: false, taxiFromCityStation: 35 },
      { name: '箱根神社', area: '芦ノ湖', duration: 40, indoor: false, taxiFromCityStation: 35 },
      { name: '芦ノ湖遊覧船', area: '芦ノ湖', duration: 50, indoor: false, taxiFromCityStation: 30 },
      { name: 'ポーラ美術館', area: '仙石原', duration: 75, indoor: true, taxiFromCityStation: 32 },
      { name: '箱根ガラスの森美術館', area: '仙石原', duration: 60, indoor: true, taxiFromCityStation: 30 },
  ...
  atami: {
    ...
    hotels: [
      ...
      },
      {
        ...
        type: '温泉旅館',
        image: null,
        features: ['全室温泉付', '隠れ家的空間', '創作和食'],
        taxiFromCityStation: 7,
        area: '熱海',
        pricePerNight: 55000,
        dinnerIncluded: true,
        breakfastIncluded: true,
      },
      {
        ...
        type: 'シティホテル',
        image: null,
        features: ['駅近', 'リーズナブル', '大浴場'],
        taxiFromCityStation: 3,
        area: '熱海駅前',
        pricePerNight: 15000,
        dinnerIncluded: false,
        breakfastIncluded: true,
    ...
    restaurants: {
      lunch: [
        { name: '囲炉茶屋', genre: '海鮮定食', area: '熱海銀座', reservationNeeded: false, budget: 3000 },
        { name: 'レストラン フレンチーナ', genre: 'イタリアン', area: '熱海', reservationNeeded: true, budget: 4000 },
        { name: '熱海プリン カフェ 2nd', genre: 'カフェ・軽食', area: '熱海銀座', reservationNeeded: false, budget: 1500 },
      ],
      dinner: [
        { name: '凪の音 熱海', genre: '和食・創作', area: '熱海', reservationNeeded: true, budget: 10000 },
        { name: '鮨処 よし田', genre: '鮨', area: '熱海', reservationNeeded: true, budget: 15000 },
        { name: 'レストラン スコット', genre: '洋食', area: '熱海銀座', reservationNeeded: false, budget: 5000 },
      ],
      snack: [
        { name: '熱海プリン', genre: 'プリン', area: '熱海銀座', budget: 500 },
        { name: '三木製菓', genre: 'ネコの舌', area: '熱海駅前', budget: 800 },
        { name: 'CAFE KICHI', genre: 'コーヒー', area: '熱海銀座', budget: 700 },
      ],
    },
    spots: [
      { name: 'MOA美術館', area: '熱海', duration: 90, indoor: true, taxiFromCityStation: 8 },
      { name: '來宮神社', area: '来宮', duration: 40, indoor: false, taxiFromCityStation: 5 },
      { name: '起雲閣', area: '熱海', duration: 50, indoor: true, taxiFromCityStation: 5 },
      { name: '熱海サンビーチ', area: '熱海', duration: 30, indoor: false, taxiFromCityStation: 3 },
      { name: 'アカオハーブ&ローズガーデン', area: '熱海', duration: 60, indoor: false, taxiFromCityStation: 10 },
      { name: '熱海銀座商店街', area: '熱海銀座', duration: 40, indoor: false, taxiFromCityStation: 3 },
    ],
  },
  hakodate: {
    name: '函館',
  ...
  sapporo: {
    ...
    hotels: [
      { id: 'sp1', name: 'JRタワーホテル日航札幌', type: 'ラグジュアリーホテル', image: null,
      ...
      { id: 'sp2', name: '定山渓温泉 章月グランドホテル', type: '温泉旅館', image: null,
  ...
  asahikawa: {
    ...
    hotels: [
      { id: 'ak1', name: 'OMO7旭川 by 星野リゾート', type: 'デザイナーズホテル', image: null,
      ...
      { id: 'ak2', name: 'ラビスタ層雲峡', type: 'リゾートホテル', image: null,
  ...
  obihiro: {
    ...
    hotels: [
      { id: 'ob1', name: 'ふく井ホテル', type: 'シティホテル', image: null,
  ...
  kushiro: {
    ...
    hotels: [
      { id: 'ku1', name: 'ANA クラウンプラザホテル釧路', type: 'シティホテル', image: null,
  ...
  abashiri: {
    ...
    hotels: [
      { id: 'ab1', name: '天都の丘 網走観光ホテル', type: 'リゾートホテル', image: null,
  ...
  wakkanai: {
    ...
    hotels: [
      { id: 'wk1', name: 'ドーミーイン稚内', type: 'ビジネスホテル', image: null,
...
function generateShinkansenTimeline(stationName, destName, departTimeStr) {
  ...
  if (destName.includes('函館')) {
    if (toSendai[stationName]) {
      const dur1 = toSendai[stationName];
      const wait = 20;
      const dur2 = times['仙台-函館'] || 159;
      totalMins = dur1 + wait + dur2;

      pushNode(t, `${stationName} 発`);
      pushEdge(`🚄 やまびこ・なすの等（約${dur1}分）`);
      t = addMins(t, dur1);
      pushNode(t, `仙台駅 着 (乗換${wait}分)`);
      t = addMins(t, wait);
      pushEdge(`🚄 はやぶさ（約${dur2}分）`);
      t = addMins(t, dur2);
      pushNode(t, `新函館北斗駅 着`);
    } else if (toOmiya[stationName]) {
      const dur1 = toOmiya[stationName];
      const wait = 20;
      ...
      t = addMins(t, dur1);
      pushNode(t, `大宮駅 着 (乗換${wait}分)`);
      t = addMins(t, wait);
      pushEdge(`🚄 はやぶさ（約${dur2}分）`);
      t = addMins(t, dur2);
      pushNode(t, `新函館北斗駅 着`);
    } else {
      const dur = times[`${stationName}-函館`] || 255;
      totalMins = dur;
      pushNode(t, `${stationName} 発`);
      pushEdge(`🚄 はやぶさ（約${dur}分）`);
      t = addMins(t, dur);
      pushNode(t, `新函館北斗駅 着`);
    }
  } else if (destName.includes('札幌') || destName.includes('小樽') || destName.includes('旭川')) {
    const hako = generateShinkansenTimeline(stationName, '函館', departTimeStr);
    const plus = destName.includes('旭川') ? 120 : 220; // 札幌220分、旭川は本来もっと遠いがデモ用
    const wait = 15;
    totalMins = hako.totalMins + wait + plus;
    
    timeline = hako.timeline;
    t = addMins(timeline[timeline.length-1].time, wait);
    pushEdge(`🚃 特急北斗等（約${plus}分）`);
    t = addMins(t, plus);
    pushNode(t, `${destName.replace('北海道', '')} 到着`);
  } else {
    // 汎用フォールバック
    const dur = times[`${stationName}-${destName}`] || 255;
    totalMins = dur;
    pushNode(t, `${stationName} 発`);
  ...
  return { time: totalMins, timeline };
}
...
function generateFlightTimeline(stationName, destName, departTimeStr) {
  ...
  if (['那須塩原', '宇都宮', '郡山', '福島', '白石蔵王'].includes(stationName)) {
    airportTransferTime = 120;
    airportTransText = '🚃 新幹線・在来線等（約120分）';
    airport = '仙台空港/羽田空港';
  }
